...
try:
    ...
    # EMM00000012 GDP:当季同比
    data=c.edb("EMM00000012", "IsLatest=0,StartDate=2010-01-01,EndDate="+date+",AdjustFlag=1,Rowindex=none,Ispandas=1")
    data.to_excel(r'C:\xyzy\1lhjr\3hgyb\gdp.xls', encoding='utf-8-sig', index=None)
    print(data)
...
# zzqz
data = xlrd.open_workbook(r'C:\xyzy\1lhjr\3hgyb\gdp.xls')
table = data.sheets()[0]
...
plt.title('我国GDP季度增速')
plt.savefig(r'C:\xyzy\1lhjr\3hgyb\gdp.png',c = 'k')
plt.show()
print('png end')

# 我国经济2022年一季度实现了4.8%，低于两会5.5%的政策目标。由于二季度遭遇到疫情冲击，经济增速将低于一季度，二季度或是全年的经济底。