...
try:
    ...
    # 社零累计同比增速（%）
    data=c.edb("EMI00135349", "IsLatest=0,StartDate=2019-12-01,EndDate="+date+",AdjustFlag=1,Rowindex=none,Ispandas=1")
    data.to_excel(r'C:\xyzy\1lhjr\3hgyb\xfplslj.xls', encoding='utf-8-sig', index=None)
...
# zzqz
data = xlrd.open_workbook(r'C:\xyzy\1lhjr\3hgyb\xfplslj.xls')
table = data.sheets()[0]
...
plt.title('社零累计同比增速（%）')
plt.savefig(r'C:\xyzy\1lhjr\3hgyb\xfplslj.png',c = 'k')
plt.show()
print('png end')