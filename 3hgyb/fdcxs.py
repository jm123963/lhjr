...
try:
    ...
    data=c.edb("EMI00120312", "IsLatest=0,StartDate=2020-01-01,EndDate="+date+",AdjustFlag=1,Rowindex=none,Ispandas=1")
    data.to_excel(r'C:\xyzy\1lhjr\3hgyb\fdcxse.xls', encoding='utf-8-sig', index=None)
    
    # EMI00120308 商品房销售面积:累计同比
    data=c.edb("EMI00120308", "IsLatest=0,StartDate=2020-01-01,EndDate="+date+",AdjustFlag=1,Rowindex=none,Ispandas=1")
    data.to_excel(r'C:\xyzy\1lhjr\3hgyb\fdcxsmj.xls', encoding='utf-8-sig', index=None)
...
# fdcxse
data = xlrd.open_workbook(r'C:\xyzy\1lhjr\3hgyb\fdcxse.xls')
table = data.sheets()[0]
...
plt.plot(x1, y1, label = "商品房销售额:累计同比")
plt.xticks(rotation=90)

# fdcxsmj
data = xlrd.open_workbook(r'C:\xyzy\1lhjr\3hgyb\fdcxsmj.xls')
table = data.sheets()[0]
st = data.sheet_by_index(0)
...
plt.plot(x1, y1, label = "商品房销售面积:累计同比")
plt.xticks(rotation=90)

plt.legend(loc='best')
plt.title('房地产销售同比增速（%）')
plt.savefig(r'C:\xyzy\1lhjr\3hgyb\fdcxs.png',c = 'k')
plt.show()
print('png end')