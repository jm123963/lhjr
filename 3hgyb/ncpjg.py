...
try:
    ...
    # EMI00009297 农产品生产价格指数:当季
    data=c.edb("EMI00009297", "IsLatest=0,StartDate=2021-01-01,EndDate="+date+",AdjustFlag=1,Rowindex=none,Ispandas=1")
    data.to_excel(r'C:\xyzy\1lhjr\3hgyb\ncpjg.xls', encoding='utf-8-sig', index=None)
...
# ncpjg
data = xlrd.open_workbook(r'C:\xyzy\1lhjr\3hgyb\ncpjg.xls')
table = data.sheets()[0]
...
plt.legend(loc='best')
plt.title('全国农产品批发价格指数:当季')
plt.savefig(r'C:\xyzy\1lhjr\3hgyb\ncpjg.png',c = 'k')
plt.show()
print('png end')

# 农产品批发价格在年初稍有跌落，在3月后开始回升上涨。