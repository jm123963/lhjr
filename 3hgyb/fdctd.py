...
try:
    ...
    # EMI00120251 房地产土地开发:本年购置土地面积:累计同比
    data=c.edb("EMI00120251", "IsLatest=0,StartDate=2019-01-01,EndDate="+date+",AdjustFlag=1,Rowindex=none,Ispandas=1")
    data.to_excel(r'C:\xyzy\1lhjr\3hgyb\fdctd.xls', encoding='utf-8-sig', index=None)
...
# fdctd
data = xlrd.open_workbook(r'C:\xyzy\1lhjr\3hgyb\fdctd.xls')
table = data.sheets()[0]
...
plt.legend(loc='best')
plt.title('房地产土地开发:本年购置土地面积:累计同比')
plt.savefig(r'C:\xyzy\1lhjr\3hgyb\fdctd.png',c = 'k')
plt.show()
print('png end')