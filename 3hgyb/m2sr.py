...
try:
    ...
    # EMM00087086 M2:同比
    data=c.edb("EMM00087086", "IsLatest=0,StartDate=2020-09-01,EndDate="+date+",AdjustFlag=1,Rowindex=none,Ispandas=1")
    data.to_excel(r'C:\xyzy\1lhjr\3hgyb\m2.xls', encoding='utf-8-sig', index=None)
    
    # EMM00191807 社会融资增量:当月同比
    data=c.edb("EMM00191807", "IsLatest=0,StartDate=2020-09-01,EndDate="+date+",AdjustFlag=1,Rowindex=none,Ispandas=1")
    data.to_excel(r'C:\xyzy\1lhjr\3hgyb\sr.xls', encoding='utf-8-sig', index=None)
...
# m2
data = xlrd.open_workbook(r'C:\xyzy\1lhjr\3hgyb\m2.xls')
table = data.sheets()[0]
...
plt.plot(x1, y1, label = "M2:同比")
plt.xticks(rotation=90)

# sr
data = xlrd.open_workbook(r'C:\xyzy\1lhjr\3hgyb\sr.xls')
table = data.sheets()[0]
st = data.sheet_by_index(0)
...
plt.plot(x1, y1, label = "社会融资增量:当月同比")
plt.xticks(rotation=90)

plt.legend(loc='best')
plt.title('M2和社融同比增速（%）')
plt.savefig(r'C:\xyzy\1lhjr\3hgyb\m2sr.png',c = 'k')
plt.show()
print('png end')

# M2同比增长11.1%，新增社融规模超预期。