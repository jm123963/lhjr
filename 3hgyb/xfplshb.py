...
try:
    ...
    # 社会消费环比增速（%）
    data=c.edb("EMM00063203", "IsLatest=0,StartDate=2021-01-01,EndDate="+date+",AdjustFlag=1,Rowindex=none,Ispandas=1")
    data.to_excel(r'C:\xyzy\1lhjr\3hgyb\xfplshb.xls', encoding='utf-8-sig', index=None)
...
# zzqz
data = xlrd.open_workbook(r'C:\xyzy\1lhjr\3hgyb\xfplshb.xls')
table = data.sheets()[0]
...
plt.title('社会消费环比增速（%）')
plt.savefig(r'C:\xyzy\1lhjr\3hgyb\xfplshb.png',c = 'k')
plt.show()
print('png end')