...
try:
    ...
    # EMM00191807 社会融资总量余额增速
    data=c.edb("EMM00191807", "IsLatest=0,StartDate=2021-01-01,EndDate="+date+",AdjustFlag=1,Rowindex=none,Ispandas=1")
    data.to_excel(r'C:\xyzy\1lhjr\3hgyb\rzye.xls', encoding='utf-8-sig', index=None)
...
# ncpjg
data = xlrd.open_workbook(r'C:\xyzy\1lhjr\3hgyb\rzye.xls')
table = data.sheets()[0]
...
plt.legend(loc='best')
plt.title('社会融资总量余额增速')
plt.savefig(r'C:\xyzy\1lhjr\3hgyb\rzye.png',c = 'k')
plt.show()
print('png end')

# 今年受地缘政治冲突、国内疫情反复影响，在1、3、4 月份融资减少较多。随着市场逐步企稳，进入5月融资余额开始缓慢回升。预计下半年融资余额将保持相对稳定。