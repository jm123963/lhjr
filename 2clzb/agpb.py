...
try:
    ...
    # 指数 涨跌幅
    data=c.csd("000002.SH","PBLYR","2010-02-01",""+date+"","DelType=1,period=3,adjustflag=1,curtype=1,order=1,market=CNSESH,Rowindex=none,Ispandas=1")
    data.to_excel(r'C:\xyzy\1lhjr\2clzb\agpb.xls', encoding='utf-8-sig', index=None)
...
data = xlrd.open_workbook(r'C:\xyzy\1lhjr\2clzb\agpb.xls')
table = data.sheets()[0]
...
plt.legend(loc='best')
plt.title('PB:全部A股',fontsize=40)
plt.savefig(r'C:\xyzy\1lhjr\2clzb\agpb.png',c = 'k')
plt.show()
print('png end')
