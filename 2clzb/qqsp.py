...
try:
    ...
    # 指数 涨跌幅
    data=c.css("AU0.SHF,CPRC.LME,ALRC.LME,ZHRC.LME,CL00Y.NYM,TA0.CZC,FG0.CZC,RB0.SHF,CF0.CZC,SR0.CZC","DIFFERRANGEW","TradeDate="+date+",AdjustFlag=1,Rowindex=none,Ispandas=1")
    data.to_excel(r'C:\xyzy\1lhjr\2clzb\qqsp.xls', encoding='utf-8-sig', index=None)
...
x1 = ['SHFE黄金','LME铜','LME铝','LME锌','NYMEX原油','CZCE PTA','CZCE玻璃','SHFE螺纹钢','CZCE棉花','CZCE白糖']
...
plt.title('全球主要商品周涨跌幅%',fontsize=40)
plt.xlabel(u"")
plt.ylabel(u"")
plt.legend()
plt.savefig(r'C:\xyzy\1lhjr\2clzb\qqsp.png',c = 'k')
