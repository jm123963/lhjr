...
try:
    ...
    # 指数 涨跌幅
    data=c.css("AU0.SHF,CPRC.LME,ALRC.LME,ZHRC.LME,CL00Y.NYM,TA0.CZC,FG0.CZC,RB0.SHF,CF0.CZC,SR0.CZC","NAME,DIFFERRANGEW","TradeDate="+date+",AdjustFlag=1,Rowindex=none,Ispandas=1")
    data.to_excel(r'C:\xyzy\1lhjr\2clzb\qqsp.xls')
...
data = xlrd.open_workbook(r'C:\xyzy\1lhjr\2clzb\qqsp.xls')
table = data.sheets()[0]
x1=[]   
...
fig.update_layout(width=1200,height=600,title={'text': "全球主要商品周涨幅%",'y':0.98,'x':0.5,'xanchor': 'center','yanchor': 'top'},title_font_size=45,font_size=20,title_font_color='red',xaxis_tickangle=-45,showlegend=False,xaxis_title=None,yaxis_title=None)
fig.write_image(r'C:\xyzy\1lhjr\2clzb\qqsp.png')