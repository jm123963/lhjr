...
try:
    ...
    # 指数 涨跌幅
    data=c.css("CI005001.CI,CI005002.CI,CI005003.CI,CI005004.CI,CI005005.CI,CI005006.CI,CI005007.CI,CI005008.CI,CI005009.CI,CI005010.CI,CI005011.CI,CI005012.CI,CI005013.CI,CI005014.CI,CI005015.CI,CI005016.CI,CI005017.CI,CI005018.CI,CI005019.CI,CI005020.CI,CI005021.CI,CI005022.CI,CI005023.CI,CI005024.CI,CI005025.CI,CI005026.CI,CI005027.CI,CI005028.CI,CI005029.CI,CI005030.CI","DIFFERRANGEW","N=0,TradeDate="+date+",AdjustFlag=1,Ispandas=1")
    data.to_excel(r'C:\xyzy\1lhjr\2clzb\zxhy.xls', encoding='utf-8-sig', index=None)
...
df.to_excel(r'C:\xyzy\1lhjr\2clzb\zxhy.xls', sheet_name='Sheet1', index=False) 
...
import pandas as pd
stexcel=pd.read_excel(r'C:\xyzy\1lhjr\2clzb\zxhy.xls')
#ascending 默认等于True，按从小到大排列，改为False 按从大到小排
stexcel.sort_values(by='行业涨幅',inplace=True,ascending=False)
stexcel.to_excel(r'C:\xyzy\1lhjr\2clzb\zxhy.xls', sheet_name='Sheet1', index=False)
...
plt.title('中信一级行业周涨跌幅%',fontsize=40)
plt.xlabel(u"")
plt.ylabel(u"")
plt.legend()
plt.savefig(r'C:\xyzy\1lhjr\2clzb\zxhy.png',c = 'k')