...
try:
    ...
    # 指数 涨跌幅
    data=c.css("CI005917.CI,CI005918.CI,CI005919.CI,CI005920.CI,CI005921.CI","DIFFERRANGEW","TradeDate="+date+",AdjustFlag=1,Rowindex=none,Ispandas=1")
    data.to_excel(r'C:\xyzy\1lhjr\2clzb\agfgzdf.xls', encoding='utf-8-sig', index=None)
...
plt.title('行业风格周涨跌幅%',fontsize=40)
plt.xlabel(u"")
plt.ylabel(u"")
plt.legend()
plt.savefig(r'C:\xyzy\1lhjr\2clzb\agfgzdf.png',c = 'k')
