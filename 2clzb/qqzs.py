...
try:
    ...
    # 指数 涨跌幅
    data=c.css("000001.SH,HSI.HI,SPX.GI,FTSE.GI,FCHI.GI,GDAXI.GI,N225.GI,KS11.GI","DIFFERRANGEW","TradeDate="+date+",AdjustFlag=1,Rowindex=none,Ispandas=1")
    data.to_excel(r'C:\xyzy\1lhjr\2clzb\qqzs.xls', encoding='utf-8-sig', index=None)
...
x1 = ['上证指数','恒生指数','标普500','英国富时100','法国CAC40','德国DAX','日经225','韩国综合指数']
...
plt.title('全球主要指数周涨跌幅%',fontsize=40)
plt.xlabel(u"")
plt.ylabel(u"")
plt.legend()
plt.savefig(r'C:\xyzy\1lhjr\2clzb\qqzs.png',c = 'k')
