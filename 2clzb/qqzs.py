...
try:
    ...
    # 指数 涨跌幅
    data=c.css("000001.SH,HSI.HI,SPX.GI,FTSE.GI,FCHI.GI,GDAXI.GI,N225.GI,KS11.GI","NAME,DIFFERRANGEW","TradeDate="+date+",AdjustFlag=1,Rowindex=none,Ispandas=1")
    data.to_excel(r'C:\xyzy\1lhjr\2clzb\qqzs.xls')
...
data = xlrd.open_workbook(r'C:\xyzy\1lhjr\2clzb\qqzs.xls')
table = data.sheets()[0]
x1=[]   
...
fig.update_layout(width=1200,height=600,title={'text': "全球主要指数周涨幅%",'y':0.98,'x':0.5,'xanchor': 'center','yanchor': 'top'},title_font_size=45,font_size=20,title_font_color='red',xaxis_tickangle=-45,showlegend=False,xaxis_title=None,yaxis_title=None)
fig.write_image(r'C:\xyzy\1lhjr\2clzb\qqzs.png')