...
try:
    ...
    # 指数 涨跌幅
    data=c.csd("SPX.GI","PETTM","2012-01-01",""+date+"","DelType=1,period=3,adjustflag=1,curtype=1,order=1,market=CNSESH,Rowindex=none,Ispandas=1")
    data.to_excel(r'C:\xyzy\1lhjr\2clzb\bppe.xls', encoding='utf-8-sig', index=None)
...
data = xlrd.open_workbook(r'C:\xyzy\1lhjr\2clzb\bppe.xls')
table = data.sheets()[0]
...
plt.legend(loc='best')
plt.title('标普500PE(TTM)',fontsize=40)
plt.savefig(r'C:\xyzy\1lhjr\2clzb\bppe.png',c = 'k')
print('png end')
