...
# 行业PB走势
fig = px.line(hypb,x='DATES', y='PBMRQ', color='CODES')
fig.update_layout(xaxis = dict(tickmode='linear',tick0 = 1,dtick = 24,),width=1200,height=600,title={'text': "行业PB走势-20年",'y':0.98,'x':0.5,
            'xanchor': 'center','yanchor': 'top'},title_font_size=35,font_size=15,title_font_color='red',xaxis_tickangle=-45,xaxis_title=None,yaxis_title=None)
fig.update_yaxes(type='log')
fig.write_image(r'C:\xyzy\1lhjr\1scrb\hyPB2.png',scale=3)