...
try:
    ...
    # 指数 涨跌幅
    data=c.css("399373.SZ,399375.SZ,399377.SZ,399372.SZ,399374.SZ,399376.SZ","NAME,DIFFERRANGEW","TradeDate="+date+",AdjustFlag=1,Rowindex=none,Ispandas=1")
    data.to_excel(r'C:\xyzy\1lhjr\2clzb\fgzf.xls')
...
data = xlrd.open_workbook(r'C:\xyzy\1lhjr\2clzb\fgzf.xls')
table = data.sheets()[0]
x1=[]   
...
fig.update_layout(width=1200,height=600,title={'text': "风格指数周涨幅%",'y':0.98,'x':0.5,'xanchor': 'center','yanchor': 'top'},title_font_size=45,font_size=20,title_font_color='red',showlegend=False,xaxis_title=None,yaxis_title=None)
fig.write_image(r'C:\xyzy\1lhjr\2clzb\fgzf.png')