...
try:
    ...
    data.to_excel(r'C:\xyzy\1lhjr\2clzb\jz.xls', encoding='utf-8-sig', index=None)
...
wb = xw.Book(r'C:\xyzy\1lhjr\2clzb\cz.xls')
sht = wb.sheets[0]
...
wb = xw.Book(r'C:\xyzy\1lhjr\2clzb\jz.xls')
sht = wb.sheets[0]
rng = sht.range('c1').expand('table')
nrows = rng.rows.count
...
l1 = dp
l2 = xp
df = DataFrame({'cz': l1, 'jz': l2})
df.to_excel(r'C:\xyzy\1lhjr\2clzb\czjz.xls', sheet_name='Sheet1', index=False)

import numpy as np 
import pandas as pd
data_= pd.read_excel(r'C:\xyzy\1lhjr\2clzb\czjz.xls')
a = np.array(data_['cz'])
b = np.array(data_['jz'])
c = a/b
data_['czcyjz'] = c
data_['czcyjz'].to_excel(r'C:\xyzy\1lhjr\2clzb\czcyjz.xls', index=False)
...
wb = xw.Book(r'C:\xyzy\1lhjr\2clzb\czcyjz.xls')
sht = wb.sheets[0]
...
df.to_excel(r'C:\xyzy\1lhjr\2clzb\czcyjz.xls', sheet_name='Sheet1', index=False)
...
x1=[]
data = xlrd.open_workbook(r'C:\xyzy\1lhjr\2clzb\czcyjz.xls')
table = data.sheets()[0]
...
plt.title('国证成长/国证价值',fontsize=40)
plt.xlabel(u"")
plt.ylabel(u"")
plt.grid(True)
plt.legend()
plt.savefig(r'C:\xyzy\1lhjr\2clzb\czjz.png',c = 'k')
