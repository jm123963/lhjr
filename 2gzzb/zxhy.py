...
try:
    ...
    # 指数 涨跌幅
    data=c.css("CI005001.CI,CI005002.CI,CI005003.CI,CI005004.CI,CI005005.CI,CI005006.CI,CI005007.CI,CI005008.CI,CI005009.CI,CI005010.CI,CI005011.CI,CI005012.CI,CI005013.CI,CI005014.CI,CI005015.CI,CI005016.CI,CI005017.CI,CI005018.CI,CI005019.CI,CI005020.CI,CI005021.CI,CI005022.CI,CI005023.CI,CI005024.CI,CI005025.CI,CI005026.CI,CI005027.CI,CI005028.CI,CI005029.CI,CI005030.CI","NAME,DIFFERRANGEW","N=0,TradeDate="+date+",AdjustFlag=1,Ispandas=1")
    data =data.sort_values(by="DIFFERRANGEW",ascending=False)
    data.to_excel(r'C:\xyzy\1lhjr\2clzb\zxhy.xls')
...
data = xlrd.open_workbook(r'C:\xyzy\1lhjr\2clzb\zxhy.xls')
table = data.sheets()[0]
x1=[]   
cap1 = table.col_values(2)
for i in range(1,31):
    x1.append(cap1[i].strip("中信一级指数"))
y1=[]   
...
fig.update_layout(width=1200,height=600,title={'text':'中信一级行业周涨幅%','y':0.98,'x':0.5,'xanchor': 'center','yanchor': 'top'},title_font_size=45,font_size=20,title_font_color='red',xaxis_tickangle=-45,showlegend=False,xaxis_title=None,yaxis_title=None)
fig.write_image(r'C:\xyzy\1lhjr\2clzb\zxhy.png')
