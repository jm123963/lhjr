...
try:
    ...
    data.to_excel(r'C:\xyzy\1lhjr\2clzb\dp.xls', encoding='utf-8-sig', index=None)
    ...
    data.to_excel(r'C:\xyzy\1lhjr\2clzb\xp.xls', encoding='utf-8-sig', index=None)
...
wb = xw.Book(r'C:\xyzy\1lhjr\2clzb\dp.xls')
sht = wb.sheets[0]
rng = sht.range('c1').expand('table')
nrows = rng.rows.count
dp = sht.range(f'c2:c{nrows}').value
wb.close()

wb = xw.Book(r'C:\xyzy\1lhjr\2clzb\xp.xls')
sht = wb.sheets[0]
rng = sht.range('c1').expand('table')
nrows = rng.rows.count
xp = sht.range(f'c2:c{nrows}').value
wb.close()
...
l1 = dp
l2 = xp
df = DataFrame({'dp': l1, 'xp': l2})
df.to_excel(r'C:\xyzy\1lhjr\2clzb\dpxp.xls', sheet_name='Sheet1', index=False)

import numpy as np 
import pandas as pd
data_= pd.read_excel(r'C:\xyzy\1lhjr\2clzb\dpxp.xls')
a = np.array(data_['dp'])
b = np.array(data_['xp'])
c = b/a
data_['dpcyxp'] = c
data_['dpcyxp'].to_excel(r'C:\xyzy\1lhjr\2clzb\dpcyxp.xls', index=False)
...
wb = xw.Book(r'C:\xyzy\1lhjr\2clzb\dpcyxp.xls')
sht = wb.sheets[0]
...
df.to_excel(r'C:\xyzy\1lhjr\2clzb\dpcyxp.xls', sheet_name='Sheet1', index=False)
...
x1=[]
data = xlrd.open_workbook(r'C:\xyzy\1lhjr\2clzb\dpcyxp.xls')
table = data.sheets()[0]
...
plt.gca().xaxis.set_major_locator(ticker.MultipleLocator(56))
...
plt.title('巨潮小盘/巨潮大盘',fontsize=40)
plt.xlabel(u"")
plt.ylabel(u"")
plt.grid(True)
plt.legend()
plt.savefig(r'C:\xyzy\1lhjr\2clzb\dpxp.png',c = 'k')
