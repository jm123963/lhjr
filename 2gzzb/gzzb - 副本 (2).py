...
zs(zscode,'PETTM','2010-01-01',3,'指数PE13年分位','zspefw13')
...
fwpb(fgcode,"PBMRQ","2005-01-01",3,"风格PE13年分位",'fgpefw13',4)
...
fwpb(hfcode,"PBMRQ","2005-01-01",3,"行业风格PE13年分位",'hfpefw13',5)
